...
if(isset($_POST["fname"]) && isset($_POST["sname"]) && isset($_POST["pass"]) && isset($_POST["submit"])){
    ...
    $p = $_POST['sname'];
    $q = $_POST['pass'];
    $s = "SELECT * from users where user_id='$u' and password= '$q'";
	$result = mysqli_query($conn , $s);
	if (mysqli_num_rows($result)>0){
        
		$sql = "UPDATE users SET user_id = '$p' WHERE user_id = '$u'";
	...
	<section id = "section1">
        <div id="box">
            <form class="form_design" method="post">
                <input id="text" type="text" placeholder="Current User ID " name="fname">
                <input id="text" type="text" placeholder="New User ID " name="sname">
