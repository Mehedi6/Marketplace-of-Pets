            ...
            <ul class="nav navbar-nav">
                ...
                <li <?php echo $page_title=="Cart" ? "class='active'" : ""; ?> >
                    <a href="cart.php">
                        ...
                        <div class="btn-group">
                            <a href="products_dogs.php" class="btn btn-primary">Dog toys</a>
                            <a href="products_cats.php" class="btn btn-primary">Cat toys</a>
                            <a href="products_birds.php" class="btn btn-primary">Bird toys</a>
                        </div>
                    </a>
                </li>
            </ul>
