<html lang="en">
  ...
  <body> 
	...
	<section id="header">
		<div class="row">  
            ...
            <a href="volunteers.php" style="margin-left: 20px;"> Volunteers </a> 
                ...
                <a href="show_pets.php" style="margin-left: 20px;"> Lost_Pets  </a>
			</div>
		</div>
	</section>
	...
	<section id = "section1">
    <div id="box">
        <form action="add_volunteers.php" class="form_design" method="post">
         <input id="text" type="submit" name="submit1" value="Add New Volunteer!">
         
      </form>
        <form action="show_volunteers.php" class="form_design" method="post">
         <input id="text" type="submit" name="submit1" value="Show Volunteers List!">
