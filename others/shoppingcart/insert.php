                    ...
                    <div class="card-body">
                        ...
                        <form action="upload.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" required class="form-control" placeholder="Enter information">
                                
                            </div>
                            <div class="form-group">
                                <label>Category</label>
                                <input type="number" name="category" required class="form-control" placeholder="Enter information">                               
                            </div>
                            <div class="form-group">
                                <label>Quantity</label>
                                <input type="number" name="quantity" required class="form-control" placeholder="Enter information">               
                            </div>
                            <div class="form-group">
