...
<a style="margin-left: 25%;margin-right: 25% ">
<table class="table" border="1">
<thead>
    <b><h1 style="color: black">Assigned Volunteers for Rescue</h1></b>
<tr>
<th>Vid</th>
<th>Hid</th>
<th>V_Contact</th>
...
$query="select v.ID,r.hID,v.Contact FROM volunteers v, rescue r where v.Address=r.hLocation";
