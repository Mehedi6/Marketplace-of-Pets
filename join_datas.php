	...
	<!-- <section id = "section1">
		...
		<div style="margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;background:#66b3ff;">
			...
			<div class="row" style="padding:5px;"> 
				...
				<div class="col-md-2">  QUALIFICATIONS </div>
			...
			<div class="row" style="padding:5px;"> 
                ...
                <div class="col-md-2">  <?php echo $row['location']; ?> </div>
                <div class="col-md-2">  <?php echo $row['contact']; ?> </div>
				<div class="col-md-2">  <?php echo $row['fees']; ?> </div>
				<div class="col-md-2">  <?php echo $row['category']; ?> </div>

                <div class="col-md-2">  <?php echo $row['qualification']; ?> </div>
