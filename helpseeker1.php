      ...
      <a id="button" href="logout.php" style="margin-left=310%;">Sign out</a>
        <br><br/> 
            ...
            <a href="volunteers1.php" style="margin-left: 20px;"> Volunteers </a> 
                ...
                <a href="vets1.php" style="margin-left: 20px;"> Vets  </a>
                <a href="fosterhome1.php" style="margin-left: 20px;"> Foster-Home  </a>
                <a href="#" style="margin-left: 20px;"> Marketplace  </a>
                <a href="pets1.php" style="margin-left: 20px;"> Lost_Pets  </a>
			</div>
		</div>
	</section>
